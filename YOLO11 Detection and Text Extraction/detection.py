...
def main():
    try:
        system = ParkingDetectionSystem(
            model_path=r'C:\Users\Public\Documents\DL-AutoParking-IoT-main\YOLO11 Detection and Text Extraction\runs\train\weights\best.pt',
            coordinates_path=r'C:\Users\Public\Documents\DL-AutoParking-IoT-main\YOLO11 Detection and Text Extraction\coordinates.txt'
            #coordinates_path=r'C:\Users\pinky\OneDrive\Documents\Desktop\Detection\live.txt'
        )

        # Video source - can be camera index or path
        video_source = r'C:\Users\Public\Documents\DL-AutoParking-IoT-main\YOLO11 Detection and Text Extraction\Demo_VIdeo.mp4'
